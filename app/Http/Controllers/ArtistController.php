...
class ArtistController extends Controller
{
    ...
    {
       $artist = ArtistModel::orderBy('id', 'desc')->paginate(50);
    ...
    public function create()
    {
        ...
        return view('artist.create',compact('countries','categories'));
    }
    ...
    {
        $user = ArtistModel::find($id);

        return view('artist.show', compact('user'));
    }
    ...
    public function edit($id)
    {
        ...
        $categories = ProductCategoryModel::with('children')->whereNull('parentcatid')->where('isactive',1)->get();
        $countries = CountryModel::all();
        return view('artist.update',compact('customer','id','categories','countries'));
    }
    ...
    public function forgotpage(){
        return view('artist.Forgotpasswordpage');
    }
