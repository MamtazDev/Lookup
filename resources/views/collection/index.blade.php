        ...
        <div class="card">
            <div class="card-header">
                    ...
                    <span class="float-right">
                        <a class="btn btn-primary btn-radius" href="{{ route('collections.create') }}">New Collection</a>
                    </span>
                   ...
                   @error('status')
                    ...
                    @enderror
                                ...
                                <td>
                                        ...
                                        <a class="btn btn-primary" href="{{ route('collections.edit',$category->id) }}"><i class="fa fa-edit"></i></a>
                                  <form method="POST" action="{{ route('collections.destroy', $category->id) }}" style="display: inline-block">
                            @csrf
...
<script>
   ...
   var status = $(this).prop('checked') == true ? 1 : 0; 
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "{{ route('collectionchangestatus') }}",
