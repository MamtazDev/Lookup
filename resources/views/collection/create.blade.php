...
<div class="container">
    <div class="justify-content-center">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <span class="float-right">
                    <a class="btn btn-primary btn-radius" href="{{ route('collections.index') }}">See all Collections</a>
                </span>
               
            </div>
            <div class="card-body">
                {!! Form::open(array('route' => 'collections.store','method'=>'POST','files' => 'true')) !!}
      ...
      <img height="120" width="150" class="img-thumbnail" src="#" id="preview" onerror="this.onerror=null;this.src='{{url('/public/image/'.$products['featuredimage'])}}'">
                    ...
                    <button type="submit" style="margin-left: 50%; margin-top: 40px;" class="btn btn-primary">Submit</button>
                {!! Form::close() !!}
            </div>
        </div>
    </div>
