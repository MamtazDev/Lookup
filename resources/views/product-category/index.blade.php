            ...
            <div class="card-header">
                @can('product-category-create')
                    <span class="float-right">
                        <a class="btn btn-primary btn-radius" href="{{ route('product-category.create') }}">New Category</a>
                    </span>
                @endcan
            </div>
            <div class="card-body">
                    ...
                    @enderror
                                ...
                                <td>
                                    ...
                                    @can('product-category-edit')
                                        <a class="btn btn-primary" href="{{ route('product-category.edit',$category->id) }}"><i class="fa fa-edit"></i></a>
                                    @endcan
                                    @can('product-category-delete')
                                    <form method="POST" action="{{ route('product-category.destroy', $category->id) }}" style="display: inline-block">
                            @csrf
