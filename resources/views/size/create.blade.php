...
<div class="container">
    <div class="justify-content-center">
        ...
        @endif
        <div class="card">
            <div class="card-header" style="padding-left: 40%;">Create new size
                 @can('sizes-list')
      ...
      <img height="120" width="150" class="img-thumbnail" src="#" id="preview" onerror="this.onerror=null;this.src='{{url('/public/image/'.$products['featuredimage'])}}'">
                    ...
                    <button type="submit" class="btn btn-primary" style="margin-top:50px; margin-left: 26%;">Submit</button>
                </form>
            </div>
        </div>
    </div>
